class Solution {
    ...
    private static Hand left, right;
    ...
    private void move(int num, String hand, Hand left, Hand right) {
        int leftDist = distance(num, left), rightDist = distance(num, right);
        
        if(num % 3 == 1 || ((num % 3 == 2 || num == 0) && 
                            (leftDist < rightDist || (leftDist == rightDist && hand.equals("left"))))) {
            result.append('L'); 
    ...
    public String solution(int[] numbers, String hand) {
        ...
        for(int number : numbers) move(number, hand, left, right);
